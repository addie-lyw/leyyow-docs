...
<Columns cols={2}>
  <Column>
    <Card title="Getting started" type="info" icon="play" href="/quickstart">
      Four steps from a fresh store to your first order
    </Card>
  </Column>
  <Column>
    <Card title="Authentication" type="info" icon="lock">
...
<Columns cols={2}>
  <Column>
    <Card title="Getting started" type="info" icon="warning">
      Four steps from a fresh store to your first order
    </Card>
  </Column>
  <Column>
    <Card title="Authentication" type="info" icon="book-open">
      How your API key authorises every request
    </Card>
  </Column>
</Columns>
